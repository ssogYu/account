            ...
            <View>
              ...
              <View style={s.heroMeta}>
                <View
                  style={[
                    s.roleBadge,
                    isOwner ? s.roleBadgeOwner : s.roleBadgeMember,
                  ]}
                >
                  <Text
                    style={[
            ...
            {family.members.map((member, idx) => {
              ...
              return (
                <View
                  ...
                  style={[
                    s.memberRow,
                    idx < family.members.length - 1 && s.memberRowBorder,
                  ]}
                >
                  <View style={s.memberAvatar}>
                    <Text style={s.memberAvatarChar}>
      ...
      >
        <Animated.View style={[s.backdrop, { opacity }]}>
          ...
          >
            ...
            >
              {step === "main" &&
                (family ? renderFamilyInfo() : renderNoFamily())}
